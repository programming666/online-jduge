...
function AdminEditProblem() {
  ...
  if (loading) {
    return <div className="max-w-4xl mx-auto p-8 dark:text-gray-300">{t('common.loading')}</div>;
  }

  if (error) {
    return <div className="max-w-4xl mx-auto p-8 text-red-600 dark:text-red-400">{error}</div>;
  }

  return (
    <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
      <h2 className="text-2xl font-bold text-primary dark:text-blue-400 mb-6">{t('problem.edit.title')} #{id}</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 gap-6">
          <div>
            <label className="block text-gray-700 dark:text-gray-300 font-bold mb-2">{t('problem.add.problemTitle')}</label>
            <input required type="text" name="title" value={form.title} onChange={handleChange} className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-2 rounded focus:ring-2 focus:ring-primary focus:outline-none placeholder-gray-500 dark:placeholder-gray-400" />
            </div>

            <div>
              <label className="block text-gray-700 dark:text-gray-300 font-bold mb-2">{t('problem.detail.difficulty')}</label>
              <select name="difficulty" value={form.difficulty} onChange={handleChange} className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-2 rounded focus:ring-2 focus:ring-primary focus:outline-none">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-2 rounded focus:ring-2 focus:ring-primary focus:outline-none placeholder-gray-500 dark:placeholder-gray-400"
              />
            </div>
        ...
        <div className="grid grid-cols-2 gap-6 bg-gray-50 dark:bg-gray-700/50 p-4 rounded border border-gray-200 dark:border-gray-600">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-2 rounded focus:ring-2 focus:ring-primary focus:outline-none"
            />
          </div>
          <div>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded border border-yellow-200 dark:border-yellow-900/50">
          <h3 className="font-bold text-secondary dark:text-yellow-400 mb-3">{t('problem.add.languageSpecific')}</h3>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-2 rounded font-mono text-sm focus:ring-2 focus:ring-primary focus:outline-none"
            />
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              type="button"
              onClick={addTestCase}
              className="text-primary dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold"
            >
          ...
          {testCases.map((tc, index) => (
            <div key={index} className="mb-4 p-4 border border-gray-200 dark:border-gray-600 rounded relative bg-gray-50 dark:bg-gray-700/50">
              <button
                type="button"
